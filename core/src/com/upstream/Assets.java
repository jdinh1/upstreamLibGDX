...
public class Assets {
	...
	public static Animation frogDemo;
	...
	public static Animation heronStanding;
	public static Animation heronStrike;
	...
	public static void load () {
		...
		items3 = loadTexture("data/items3.png");
		...
		shark = new Animation(.05f, new TextureRegion(items2, 70, 295, 65, 50),new TextureRegion(items2, 144, 290, 66, 62),
				new TextureRegion(items2, 211, 284,85, 73), new TextureRegion(items2, 298, 284, 80, 72),
				new TextureRegion(items2, 380, 284, 70, 76), new TextureRegion(items2, 10, 295, 65, 50)	);
		...
		frogDemo = new Animation(1/5f, new TextureRegion(items2, 4, 101, 48, 46),new TextureRegion(items2, 55, 104, 51, 42),
				new TextureRegion(items2, 104, 101, 53, 44),new TextureRegion(items2, 158, 93, 47, 60),new TextureRegion(items2, 206, 94, 52, 56),
				new TextureRegion(items2, 261, 95, 48, 53), new TextureRegion(items2, 312, 94, 48, 52), new TextureRegion(items2, 361, 96, 50, 54),
				new TextureRegion(items2, 410, 93, 54, 55), new TextureRegion(items2, 464, 95, 48, 53), new TextureRegion(items2, 360, 158, 54, 46));
		heronStanding = new Animation(0.2f, new TextureRegion(items3, 3, 4, 69, 86), new TextureRegion(items3, 72, 2, 70, 87),
				new TextureRegion(items3, 142, 2, 68, 85), new TextureRegion(items3, 210, 1, 69, 87) );
		heronStrike = new Animation(0.05f, new TextureRegion(items3, 3, 4, 69, 86), new TextureRegion(items3, 72, 2, 70, 87),
				new TextureRegion(items3, 142, 2, 68, 85), new TextureRegion(items3, 210, 1, 69, 87), new TextureRegion(items3, 279, 1, 77, 87),
				new TextureRegion(items3, 356, 2, 79, 87), new TextureRegion(items3, 1, 90, 85, 71), new TextureRegion(items3, 91, 90, 85, 71),
				new TextureRegion(items3, 180, 88, 92, 72), new TextureRegion(items3, 1, 90, 85, 71), new TextureRegion(items3, 279, 1, 77, 87) );
