...
public class TreeLog extends DynamicGameObject {
	public static final float PLATFORM_WIDTH = .75f;
	public static final float PLATFORM_HEIGHT = 2f;
	...
	public static final float LOG_SCORE = 2;

	int type;
	int state;
	float stateTime;

	public TreeLog(float x, float y) {
